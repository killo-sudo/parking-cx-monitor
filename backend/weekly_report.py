...
/* TOP STORY */
.top-story { padding: 28px 32px 32px; border-bottom: 2px solid var(--ink); display: grid; grid-template-columns: minmax(0, 1.5fr) minmax(0, 1fr); gap: 36px; background: var(--card); }
