...
{{
  ...
  "ai_suggestions_page1": [
    {{"icon": "💡", "title": "🤖 AI 제안 1", "body": "..."}},
    {{"icon": "🎯", "title": "🤖 AI 제안 2", "body": "..."}},
    {{"icon": "🔧", "title": "🤖 AI 제안 3", "body": "..."}}
  ],
...
5. service_complaints_page1: 4개 카드. 환불/주차권·이용/결제·시스템/현장업체 카테고리 기반. 데이터 수치 정확히 반영.
6. response_quality_page2: 4개 카드. 상담응대지연/채팅자동종료/기계적응대/환불안내불일치 기반.
7. ai_suggestions_page1/page2: 정확히 3개씩. [A][B][C][D] 정책 근거 반영. 이용자 귀책 불만이면 '정책 안내 강화' 방향.
8. summary_page1/page2: 각 4~6개. 🔴(긴급) 🟡(단기) 🟢(중기) 🔵(장기) 순서. 데이터에서 직접 도출.
9. 모든 수치는 데이터에서 정확히 가져와야 함. 추측 금지.
10. JSON만 출력. 코드 블록 ```json 도 금지. 순수 JSON 텍스트만."""
